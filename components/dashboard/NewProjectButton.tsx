...
export function NewProjectButton({ className }: NewProjectButtonProps) {
              ...
              <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-[1fr_340px]">
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    <div>
                      <label className="text-sm text-gray-600">
                        Largura da Impressão <span className="text-red-500">*</span>
                      </label>
                    ...
                    <div>
                      <label className="text-sm text-gray-600">
                        Altura da Impressão <span className="text-red-500">*</span>
                      </label>
                      <div className="mt-2 flex items-end gap-3">
                        <input
                          type="number"
