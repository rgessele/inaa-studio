...
import { insertDartIntoLine, insertDartIntoRectangle, insertDartIntoPolyline } from './dart';
...
export function visualizeDart() {
  ...
  console.log('');
  console.log('Points Array: [P1.x, P1.y, L.x, L.y, A.x, A.y, R.x, R.y, P2.x, P2.y]');
  console.log('───────────────────────────────────────\n');
}
